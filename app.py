...
app = Flask(__name__)
CORS(app, resources={r"/*": {"origins": "https://mg-project.onrender.com"}})
...
app.config['MAIL_USERNAME'] = os.getenv('MAIL_USERNAME', 'dajafranko@gmail.com')
app.config['MAIL_PASSWORD'] = os.getenv('MAIL_PASSWORD', 'vnsg csai ljzf fdws')
mail = Mail(app)
